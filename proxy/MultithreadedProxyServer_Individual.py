...
http_model = joblib.load('./model/http_svm.sav')
http_scaller = joblib.load('./scaler/http_svm.save')
                        ...
                        if(protocol_data[0][0][2] == "TCP"):
                            for ip_data in protocol_data:
                                if(len(ip_data) != 0):
                                    ...
                                    input_data = [timestamp_std, no_thread_std, connection_time_std, r_bytes_std, r_bytes_sum, port_src_std, status_std, url_std, connection_timeout_std, rate_connection]

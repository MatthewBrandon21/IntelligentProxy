...
tcp_lstm_scaler = joblib.load('./scaler/tcp_lstm_200.save')
tcp_lstm_model = load_model('./model/tcp_lstm_200.h5')
udp_lstm_scaler = joblib.load('./scaler/udp_lstm_200.save')
